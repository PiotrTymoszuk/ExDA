...
# Effect size --------
  ...
  eff_size(test1, test2, type = 'freeman_theta',
           ci = FALSE, boot_method = 'bca')

  eff_size(test1, test5,
           type = 'cramer_v', ci = TRUE)

  eff_size(test1, test2,
           type = 'cramer_v', ci = TRUE)

  eff_size(test3, test4,
           type = 'paired_cohen_d')

  eff_size(test3, test6,
           type = 'paired_wilcoxon_r',
           ci = TRUE,
           boot_method = 'normality')

  eff_size(test1, test2, test5,
           type = 'cohen_kappa')

  eff_size(test3, test4, test6,
           type = 'kendall_w')
...
# Testing the 'x_n_labs' option: n numbers in the X axis ---------
